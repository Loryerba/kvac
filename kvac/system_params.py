...
class SystemParams(NamedTuple):
    ...
    def generate(cls, max_attributes: int, label: str) -> SystemParams:
        ...
        number.
        max_attributes is the maximum number of attributes the generated parameters will support.
        In other words, this number needs to be >= the maximum number of attribute components any Credential using
        the newly created system params will have.
        """
